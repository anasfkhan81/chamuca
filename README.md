...
[Run query (.txt)](https://lari-datasets.ilc.cnr.it/chamuca/sparql?query=PREFIX%20ontolex%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Flemon%2Fontolex%23%3E%0APREFIX%20lexinfo%3A%20%3Chttp%3A%2F%2Fwww.lexinfo.net%2Fontology%2F2.0%2Flexinfo%23%3E%0A%0ASELECT%20%3FhindiWordConcat%20%3Fhgen%20%3FportugueseWord%20%3Fpgen%20WHERE%20%7B%0A%0A%20%20%7B%0A%20%20%20%20SELECT%20%3FhEntry%20%28GROUP_CONCAT%28STR%28%3FhindiWord%29%3B%20SEPARATOR%3D%22%20%2F%20%22%29%20AS%20%3FhindiWordConcat%29%20WHERE%20%7B%0A%20%20%20%20%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_hi_lex%3E%20%7B%0A%20%20%20%20%20%20%20%20%3FhEntry%20ontolex%3AcanonicalForm%2Fontolex%3AwrittenRep%20%3FhindiWord%20.%0A%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%20%20%20%20GROUP%20BY%20%3FhEntry%0A%20%20%7D%0A%0A%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_hi_lex%3E%20%7B%0A%20%20%20%20%3FhEntry%20a%20ontolex%3ALexicalEntry%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3AetymologicalRoot%20%3FptID%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3Agender%20%3Fhgen%20.%0A%20%20%7D%0A%0A%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_pt_lex%3E%20%7B%0A%20%20%20%20%3FptID%20ontolex%3AcanonicalForm%2Fontolex%3AwrittenRep%20%3FportugueseWord%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3Agender%20%3Fpgen%20.%0A%20%20%7D%0A%7D&output=text)

[Run query (.csv)](https://lari-datasets.ilc.cnr.it/chamuca/sparql?query=PREFIX%20ontolex%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Flemon%2Fontolex%23%3E%0APREFIX%20lexinfo%3A%20%3Chttp%3A%2F%2Fwww.lexinfo.net%2Fontology%2F2.0%2Flexinfo%23%3E%0A%0ASELECT%20%3FhindiWordConcat%20%3Fhgen%20%3FportugueseWord%20%3Fpgen%20WHERE%20%7B%0A%0A%20%20%7B%0A%20%20%20%20SELECT%20%3FhEntry%20%28GROUP_CONCAT%28STR%28%3FhindiWord%29%3B%20SEPARATOR%3D%22%20%2F%20%22%29%20AS%20%3FhindiWordConcat%29%20WHERE%20%7B%0A%20%20%20%20%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_hi_lex%3E%20%7B%0A%20%20%20%20%20%20%20%20%3FhEntry%20ontolex%3AcanonicalForm%2Fontolex%3AwrittenRep%20%3FhindiWord%20.%0A%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%20%20%20%20GROUP%20BY%20%3FhEntry%0A%20%20%7D%0A%0A%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_hi_lex%3E%20%7B%0A%20%20%20%20%3FhEntry%20a%20ontolex%3ALexicalEntry%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3AetymologicalRoot%20%3FptID%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3Agender%20%3Fhgen%20.%0A%20%20%7D%0A%0A%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_pt_lex%3E%20%7B%0A%20%20%20%20%3FptID%20ontolex%3AcanonicalForm%2Fontolex%3AwrittenRep%20%3FportugueseWord%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3Agender%20%3Fpgen%20.%0A%20%20%7D%0A%7D&output=csv)

All Urdu  lemmas and their (hypothesised) Portuguese etymons:

[Run query (.txt)](https://lari-datasets.ilc.cnr.it/chamuca/query?query=PREFIX%20ontolex%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Flemon%2Fontolex%23%3E%0APREFIX%20lexinfo%3A%20%3Chttp%3A%2F%2Fwww.lexinfo.net%2Fontology%2F2.0%2Flexinfo%23%3E%0A%0ASELECT%20%3FurduWordConcat%20%3Fugen%20%3FportugueseWord%20%3Fpgen%20WHERE%20%7B%0A%0A%20%20%23%20Subquery%20to%20concatenate%20Arabic-script%20%2B%20Latin%20forms%20%28if%20both%20exist%29%0A%20%20%7B%0A%20%20%20%20SELECT%20%3FuEntry%20%28GROUP_CONCAT%28STR%28%3FurduWord%29%3B%20SEPARATOR%3D%22%20%2F%20%22%29%20AS%20%3FurduWordConcat%29%20WHERE%20%7B%0A%20%20%20%20%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_ur_lex%3E%20%7B%0A%20%20%20%20%20%20%20%20%3FuEntry%20ontolex%3AcanonicalForm%2Fontolex%3AwrittenRep%20%3FurduWord%20.%0A%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%20%20%20%20GROUP%20BY%20%3FuEntry%0A%20%20%7D%0A%0A%20%20%23%20Get%20gender%20and%20Portuguese%20link%20from%20Urdu%20lexicon%0A%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_ur_lex%3E%20%7B%0A%20%20%20%20%3FuEntry%20a%20ontolex%3ALexicalEntry%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3AetymologicalRoot%20%3FptID%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3Agender%20%3Fugen%20.%0A%20%20%7D%0A%0A%20%20%23%20Get%20canonical%20form%20and%20gender%20from%20Portuguese%20lexicon%0A%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_pt_lex%3E%20%7B%0A%20%20%20%20%3FptID%20ontolex%3AcanonicalForm%2Fontolex%3AwrittenRep%20%3FportugueseWord%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3Agender%20%3Fpgen%20.%0A%20%20%7D%0A%7D&output=text)

[Run query (.csv)](https://lari-datasets.ilc.cnr.it/chamuca/query?query=PREFIX%20ontolex%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Flemon%2Fontolex%23%3E%0APREFIX%20lexinfo%3A%20%3Chttp%3A%2F%2Fwww.lexinfo.net%2Fontology%2F2.0%2Flexinfo%23%3E%0A%0ASELECT%20%3FurduWordConcat%20%3Fugen%20%3FportugueseWord%20%3Fpgen%20WHERE%20%7B%0A%0A%20%20%23%20Subquery%20to%20concatenate%20Arabic-script%20%2B%20Latin%20forms%20%28if%20both%20exist%29%0A%20%20%7B%0A%20%20%20%20SELECT%20%3FuEntry%20%28GROUP_CONCAT%28STR%28%3FurduWord%29%3B%20SEPARATOR%3D%22%20%2F%20%22%29%20AS%20%3FurduWordConcat%29%20WHERE%20%7B%0A%20%20%20%20%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_ur_lex%3E%20%7B%0A%20%20%20%20%20%20%20%20%3FuEntry%20ontolex%3AcanonicalForm%2Fontolex%3AwrittenRep%20%3FurduWord%20.%0A%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%20%20%20%20GROUP%20BY%20%3FuEntry%0A%20%20%7D%0A%0A%20%20%23%20Get%20gender%20and%20Portuguese%20link%20from%20Urdu%20lexicon%0A%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_ur_lex%3E%20%7B%0A%20%20%20%20%3FuEntry%20a%20ontolex%3ALexicalEntry%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3AetymologicalRoot%20%3FptID%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3Agender%20%3Fugen%20.%0A%20%20%7D%0A%0A%20%20%23%20Get%20canonical%20form%20and%20gender%20from%20Portuguese%20lexicon%0A%20%20GRAPH%20%3Chttps%3A%2F%2Flari-datasets.ilc.cnr.it%2Fchamuca_pt_lex%3E%20%7B%0A%20%20%20%20%3FptID%20ontolex%3AcanonicalForm%2Fontolex%3AwrittenRep%20%3FportugueseWord%20%3B%0A%20%20%20%20%20%20%20%20lexinfo%3Agender%20%3Fpgen%20.%0A%20%20%7D%0A%7D&output=csv)
